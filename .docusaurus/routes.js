...
export default [
  ...
  {
    path: '/en/docs/',
    component: ComponentCreator('/en/docs/','572'),
    routes: [
      {
        path: '/en/docs/',
        component: ComponentCreator('/en/docs/','8fc'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/介绍/02quickstart',
        component: ComponentCreator('/en/docs/介绍/02quickstart','524'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/介绍/03whatis',
        component: ComponentCreator('/en/docs/介绍/03whatis','a22'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/最佳实践/15bestpractice',
        component: ComponentCreator('/en/docs/最佳实践/15bestpractice','f51'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/最佳实践/16dledger',
        component: ComponentCreator('/en/docs/最佳实践/16dledger','364'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/最佳实践/17messagetra',
        component: ComponentCreator('/en/docs/最佳实践/17messagetra','79b'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/最佳实践/18access',
        component: ComponentCreator('/en/docs/最佳实践/18access','fe4'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/最佳实践/19JVMOS',
        component: ComponentCreator('/en/docs/最佳实践/19JVMOS','2be'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/最佳实践/20log',
        component: ComponentCreator('/en/docs/最佳实践/20log','b27'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/最佳实践/21subscribe',
        component: ComponentCreator('/en/docs/最佳实践/21subscribe','a79'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/最佳实践/22FAQ',
        component: ComponentCreator('/en/docs/最佳实践/22FAQ','36c'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/参数配置/23local',
        component: ComponentCreator('/en/docs/参数配置/23local','285'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/参数配置/24server',
        component: ComponentCreator('/en/docs/参数配置/24server','809'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/消费者/11concept2',
        component: ComponentCreator('/en/docs/消费者/11concept2','1d4'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/消费者/12push',
        component: ComponentCreator('/en/docs/消费者/12push','a06'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/消费者/13pull',
        component: ComponentCreator('/en/docs/消费者/13pull','2d9'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/生产者/04concept1',
        component: ComponentCreator('/en/docs/生产者/04concept1','baf'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/生产者/05message1',
        component: ComponentCreator('/en/docs/生产者/05message1','512'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/生产者/06message2',
        component: ComponentCreator('/en/docs/生产者/06message2','acd'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/生产者/07message3',
        component: ComponentCreator('/en/docs/生产者/07message3','f4d'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/生产者/08message4',
        component: ComponentCreator('/en/docs/生产者/08message4','8df'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/生产者/09message5',
        component: ComponentCreator('/en/docs/生产者/09message5','e7d'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/贡献指南/29how-to-contribute',
        component: ComponentCreator('/en/docs/贡献指南/29how-to-contribute','982'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/贡献指南/30code-guidelines',
        component: ComponentCreator('/en/docs/贡献指南/30code-guidelines','694'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/贡献指南/31pull-request',
        component: ComponentCreator('/en/docs/贡献指南/31pull-request','3fb'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/贡献指南/32release-manual',
        component: ComponentCreator('/en/docs/贡献指南/32release-manual','aaf'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/部署与运维/15deploy',
        component: ComponentCreator('/en/docs/部署与运维/15deploy','c18'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/部署与运维/16admintool',
        component: ComponentCreator('/en/docs/部署与运维/16admintool','dff'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/部署与运维/17Dashboard',
        component: ComponentCreator('/en/docs/部署与运维/17Dashboard','fc5'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      },
      {
        path: '/en/docs/部署与运维/18Exporter',
        component: ComponentCreator('/en/docs/部署与运维/18Exporter','f9d'),
        exact: true,
        'sidebar': "myAutogeneratedSidebar"
      }
    ]
