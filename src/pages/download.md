...
| 版本        | 文档                                                                             | 发布日期      | Source 下载                                                                                                                               | Binary 下载 | End of Support |
|-----------|--------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------| ----------- | -------------- |
| **2.3.4** | [Release Notes](https://github.com/apache/rocketmq-spring/releases/tag/rocketmq-spring-all-2.3.4) | 2025.3.14 | [download.zip](https://www.apache.org/dyn/closer.cgi?path=rocketmq/rocketmq-spring/2.3.4/rocketmq-spring-rocketmq-spring-all-2.3.4.zip) |             |                |
