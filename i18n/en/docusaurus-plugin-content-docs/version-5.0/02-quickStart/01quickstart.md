...
Apache RocketMQ is distributed both in binary and source packages.  Click [here](https://dist.apache.org/repos/dist/release/rocketmq/5.1.2/rocketmq-all-5.1.2-source-release.zip) to download Apache RocketMQ 5.1.2 source package. You may prefer [prebuilt binary package](https://dist.apache.org/repos/dist/release/rocketmq/5.1.2/rocketmq-all-5.1.2-bin-release.zip), which can be run directly since it has been compiled.

:::

The following instruction takes the application of RocketMQ 5.1.2 source package in Linux environment as an example in order to introduce the installation process of RocketMQ.

Extract the source package of RocketMQ 5.1.2, then compile and build the binary executables:
