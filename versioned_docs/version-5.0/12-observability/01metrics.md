...
- invocation_status: 创建主题或消费者组接口调用结果，枚举值包含 success 和 failure。
...
| histogram  | rocketmq_topic_create_execution_time          | millisecond | 创建主题执行耗时：<br />le_10_ms<br />le_100_ms<br />le_1_s<br />le_3_s<br />le_5_s<br />le_overflow                                                                                           | cluster,node_type,node_id,invocation_status,is_system                            |
| histogram  | rocketmq_consumer_group_create_execution_time | millisecond | 创建消费者组执行耗时：<br />le_10_ms<br />le_100_ms<br />le_1_s<br />le_3_s<br />le_5_s<br />le_overflow                                                                                         | cluster,node_type,node_id,invocation_status                                      |
